...
## 💡 Summary
This second assignment uses the same problem statement from before, but making it as a complete program instead. It requires the students to apply their technical programming skill to design the complete coding of the BMR calculator. Examples of input and output of the BMR calculator application was shown as a guide to develop the BMR calculator and students are expected to produce the same output as the example.
