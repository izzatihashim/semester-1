...
## 💡 Summary
### 🏡 — Company tour
A quick tour around the company was given by En. Azim, one of the staff member at JCorp as soon as we arrived at the building. We were able to see the work environment of the company as he introduced us to every rooms and spaces available. The areas ranging from the work area, rest area and meeting area, each specified to work for its name. The rest area consists of a small cafe for the staffs to take their daily morning coffee, and a fun room, build to give the staff members a short break after a stressful work. It is equipped with snooker table, TV, and a lounge area, all with the stunning view of the border. Aside from that, they also have meeting rooms with several purpose such as one for big meeting, small discussion or executives meeting.

### 🗣 — Sharing session
- Speaker 1: Mr. Budiman Bujang, Deputy Chief Digital Officer <br>

The sharing session highlighted the core technical aspect of the Corporation, whereas Mr. Budiman talks about how the company leverages on technology to support their businesses, involving decision-making, automation and analytics. He shared with us their evolution of digital strategy that enhance their business value, focusing on the digital empowerment on 3 main pillars, which are People, Process and Innovation. The technologies that do the work of extracting values from the pillars are the Tria Initiative, which are AI, Automation and Analytics. In addition, he also shared the digital transformation of JCorp, showing how the company moves from one digital era to another, while also learning the reason for each shiftment. As for 2026, JCorp are focusing on establishing its own Command Centre, which is a centralized system that brings together many integration of advanced technologies such as AI, advanced analytics, real-time data insights and automated anomaly detection. 
